...
5940   IF EBULLETS(I,2) <> 0 THEN GOSUB 6010
6000 NEXT I
6005 RETURN

6010 REM Enemy Bullet vs alle Wand-Blöcke prüfen
6011 FOR W = 1 TO MAXWALLS
6012   FOR B = 1 TO WALLBLOCKS
6013     LET IDX = (W - 1) * WALLBLOCKS + B
6014     IF WALLS(IDX,2) <> 0 THEN GOSUB 6025
6015   NEXT B
6016 NEXT W
6017 RETURN

6025 REM Kollision zwischen Enemy Bullet I und Wand-Block IDX prüfen
6026 IF EBULLETS(I,0) + 4 < WALLS(IDX,0) THEN RETURN
6027 IF EBULLETS(I,0) > WALLS(IDX,0) + 8 THEN RETURN
6028 IF EBULLETS(I,1) + 4 < WALLS(IDX,1) THEN RETURN
6029 IF EBULLETS(I,1) > WALLS(IDX,1) + 8 THEN RETURN
6030 REM Treffer! Block zerstören und Bullet deaktivieren
6031 LET WALLS(IDX,2) = 0
6032 LET EBULLETS(I,2) = 0
6033 SOUND 350, 80
6034 RETURN
